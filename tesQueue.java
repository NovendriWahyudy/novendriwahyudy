...
public class tesQueue {
    ...
    public void add(String input) {
        if (isEmpty()) {
            ...
            if (isFull()) {
                System.out.println(" Antrian pembayaran Indomaret ");
            } else {
                data[++tail] = input;
            }
        }
        System.out.println(input + " Antri pembayaran Indomaret ");
}
    ...
    public void remove() {
        if (isEmpty()) {
            ...
            tail--;
            System.out.println(temp + " Membayar makanan ");
        }
    }
